...
namespace MetaNN
{
    ...
    public:
        ...
        // check if the tensor is available to wrtie
        bool AvailableForWrite() const { return !m_mem.IsShared(); }
        
        // element-wise write with index
        // the last element of posValParams is the value to write
        ...
        // get sub-tensor with index at the first dimension
    ...
    private:
        MetaNN::Shape<uDim> m_shape;                        // shape information
        ContinuousMemory<ElementType, DeviceType> m_mem;    // continuous memory for storage
    };
    //=========================================================================================
    
    // Tensor<TElem, TDevice, 0> specialization ===============================================
