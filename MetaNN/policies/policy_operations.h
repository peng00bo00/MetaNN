...
struct Selector_
{
    using TMF = Sequential::Fold<PolicyContainer<>, 
                                 TPolicyContainer,
...
// remove the policy object that has conflicts with TNewPolicy (same MajorClass and MinorClass) from TOriContainer, 
// and then add TNewPolicy to TOriContainer
template <typename TNewPolicy, typename TOriContainer>
...
// pick the policy object that has TMajorClass and TMinorClass from TPolicyContainer
// if the policy object is not found, return TMajorClass
template <typename TPolicyContainer, typename TMajorClass, typename TMinorClass>
...
// check if there exists a policy object that has TMajorClass and TMinorClass from TPolicyContainer
template <typename TPolicyContainer, typename TMajorClass, typename TMinorClass>
